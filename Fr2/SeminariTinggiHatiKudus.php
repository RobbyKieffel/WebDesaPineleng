...
<body style="min-height: 600px; background-color: #fbfada;">
    ...
    <nav id="fade-element" class="w-100 fixed-top d-flex align-items-center" style="height: 80px; background-color: #12372a; color: #fbfada;">
      <div class="container">
        <div class="row">
          ...
          <h1 class="col text-center fw-bolder fs-2 my-auto" style="color: #fbfada;">Seminar Tinggi Hati Kudus</h1>
          <div class="col-2"></div>
        </div>
      </div>
    </nav>
    ...
    <main class="container my-5">
      ...
      <article class="text-center my-5">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi provident nostrum reprehenderit quidem sed esse sequi veritatis, ea aliquam, impedit voluptatem voluptate minus quos necessitatibus, assumenda doloribus inventore aspernatur magnam? Exercitationem nihil voluptatibus eaque culpa, ut non magnam ipsa iste? Nam consequuntur repudiandae cumque repellendus, ut architecto dignissimos possimus quidem inventore soluta hic in! Unde corrupti, sit nihil at, dolorum adipisci culpa minus dicta laudantium repellendus voluptatem non doloribus, quod dignissimos a quae earum quisquam illum fugiat natus eaque fuga!
          <br><br>
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Adipisci qui natus a, distinctio libero necessitatibus? Ipsam, temporibus amet ut minima aut asperiores repellat incidunt dolores ipsum doloribus sapiente cum a laborum pariatur dolor aliquid praesentium possimus tenetur. Fugiat, reprehenderit dolores? Necessitatibus dolore earum nobis. Cupiditate ipsum tenetur nulla et qui!
          <br><br>
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Adipisci qui natus a, distinctio libero necessitatibus? Ipsam, temporibus amet ut minima aut asperiores repellat incidunt dolores ipsum doloribus sapiente cum a laborum pariatur dolor aliquid praesentium possimus tenetur. Fugiat, reprehenderit dolores? Necessitatibus dolore earum nobis. Cupiditate ipsum tenetur nulla et qui!
      </article>
      ...
      <div class="row my-5">
          ...
          <img class="col-4 me-5 rounded-3" src="https://stfsp.ac.id/wp-content/uploads/2019/06/DSC_2561.jpg" alt="makatete-hills" style="object-fit: cover; width: 100%; height: 100%;">
          </div>

...
<body style="min-height: 600px; background-color: #fbfada;">
    ...
    <nav id="fade-element" class="w-100 fixed-top d-flex align-items-center" style="height: 80px; background-color: #12372a; color: #fbfada;">
      <div class="container">
        <div class="row">
          ...
          <h1 class="col text-center fw-bolder fs-2 my-auto" style="color: #fbfada;">Makam Imam Bonjol</h1>
          <div class="col-2"></div>
        </div>
      </div>
    </nav>
    ...
    <main class="container my-5">
      ...
      <article class="text-center my-5">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio corrupti ipsa cupiditate error accusantium odit eveniet, impedit minima, natus quaerat adipisci non blanditiis! Natus accusamus voluptatem sunt repellat asperiores? Officiis excepturi quisquam dolores quidem, omnis consequatur quia sequi accusamus sed.
          <br><br>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. In magnam natus officiis sit, veniam ex! Hic dolores aliquid eum possimus voluptate, officiis obcaecati dolorem aperiam omnis praesentium quos adipisci aliquam. Alias rem doloremque quas eum itaque, fuga harum laborum temporibus est nam optio quae illo veritatis dolorum eligendi ipsum in nesciunt, odit magnam nostrum architecto reprehenderit? Nihil quibusdam error pariatur amet. Commodi qui laboriosam omnis temporibus sint rerum quasi dolores debitis. Reprehenderit reiciendis assumenda quas quae ullam fugiat. Reprehenderit, natus.
          <br><br>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam itaque quaerat tempora sint ratione cupiditate modi temporibus rerum aliquam. Porro.
      </article>

      <!-- TABLE AND IMAGE -->
      <div class="row my-5">
          <div class="col-4 me-5">
          <img class="col-4 me-5 rounded-3" src="https://indonesiakaya.com/wp-content/uploads/2020/10/makam_tuanku_imam_bonjol_1200.jpg" alt="Makam-Imam-Bonjol" style="object-fit: cover; width: 100%; height: 100%;">
          </div>
